  ...
  return (
    <div className="chauffeur-section pb-5 pt-0">
      <h5 className="display-6 font-thin  text-center pb-5 mb-5 mt-0 pt-0 translate-lg-20">
        Our <span className="f-bold ">requirements</span>
      </h5>
      <Container>
        <Section
        ...
        <Section
          ...
          content={<p>Our clients highly value the security of their information, which is why each chauffeur will sign a confidentiality agreement.</p>}
        />
...
const Section = ({ icon, title, content }) => (
  <Row className="section-row align-items-center mb-5">
    <Col xs={12} md={4} className="icon-col gap-2 d-flex justify-content-start justify-content-md-start align-items-center">
      <img src={icon} width={150} />
      <h5 className="section-title fs-3 font-thin">{title}</h5>
    </Col>
    <Col xs={12} md={4} className="d-flex align-items-center justify-content-center pe-md-5">
